          ...
          <v-container grid-list-xl>
            <v-layout row wrap>
              ...
              <v-flex md10 offset-md1>
                ...
                <p>
                  B. Any contributor can decide to break the Piggy if the last contribution is older than three minutes. A winner is then chosen “randomly” e.g. the chances for a contributor to be declared winner are proportional to the amount contributed in the Piggy. For instance, a player who contributed 25 in a Piggy, which has a Piggy value of 100, has 25% chances to be chosen as winner. Once the Piggy is broken no one can contribute in it anymore and a new Piggy is instantly created with an initial Piggy value of zero. The players can now contribute in the new Piggy.<br />
                </p>
                <p>
                  C. The winner has the possibility to withdraw the total value contained in the Piggy he won minus a transaction fee equal to 3.75% of the Piggy value. FidEver can recover these funds if they have not been recovered by the player one year after its victory.
                </p>
                <h2>2. The App</h2>
                <p>
                ...
                <p>
                  B. Transactions that take place on the App are managed and confirmed via the Ethereum blockchain. You understand that your Ethereum public address will be made publicly visible whenever you engage in a transaction on the App.
                </p>
                <p>
                ...
                <p>
                  D. As between us, you will be solely responsible to pay any and all sales, use, value-added and other taxes, duties, and assessments (except taxes on our net income) now or hereafter claimed or imposed by any governmental authority (collectively, “Taxes”) associated with your use of the App (including, without limitation, any Taxes that may become payable as the result of your contribution to any of the Piggies). Except for income taxes levied on FidEver, you: (i) will pay or reimburse us for all national, federal, state, local or other taxes and assessments of any jurisdiction, including value added taxes and taxes as required by international tax treaties, customs or other import or export taxes, and amounts levied in lieu thereof based on charges set, services performed or payments made hereunder, as are now or hereafter may be imposed under the authority of any national, state, local or any other taxing jurisdiction; and (ii) shall not be entitled to deduct the amount of any such taxes, duties or assessments from payments made to us pursuant to these Terms.
                </p>
                <h2>4. Ownership; Restrictions</h2>
                <p>
                  A. You acknowledge and agree that we (or, as applicable, our licensors) own all legal right, title and interest in and to all elements of the App, and all intellectual property rights therein. The visual interfaces, graphics (including, without limitation, all art and drawings associated with the Piggy), design, systems, methods, information, computer code, software, services, “look and feel”, organization, compilation of the content, code, data, and all other elements of the App (collectively, the “FidEver Materials”) are owned by FidEver, and are protected by copyright, trade dress, patent, and trademark laws, international conventions, other relevant intellectual property and proprietary rights, and applicable laws.  All FidEver Materials are the copyrighted property of FidEver or its licensors, and all trademarks, service marks, and trade names contained in the FidEver Materials are proprietary to FidEver or its licensors. Except as expressly set forth herein, your use of the App does not grant you ownership of or any other rights with respect to any content, code, data, or other materials that you may access on or through the App. We reserve all rights in and to the FidEver Materials not expressly granted to you in the Terms. For the sake of clarity, you understand and agree: (i) that your “contribution” to a Piggy, whether via the App or otherwise, does not give you any rights or licenses in or to the FidEver Materials (including, without limitation, our copyright in and to the art and drawings associated with that Piggy) other than those expressly contained in these Terms; and (ii) that you do not have the right to reproduce, distribute, or otherwise commercialize any elements of the FidEver Materials (including, without limitation, our copyright in and to the art and drawings associated with that Piggy) in any way without our prior written consent in each case, which consent we may withhold in our sole and absolute discretion.
                </p>
                <p>
                ...
                <p>
                  D. PIGGY CONTRIBUTIONS ARE INTANGIBLE DIGITAL ASSETS THAT EXIST ONLY BY VIRTUE OF THE OWNERSHIP RECORD MAINTAINED IN THE ETHEREUM NETWORK. ALL SMART CONTRACTS ARE CONDUCTED AND OCCUR ON THE DECENTRALIZED LEDGER WITHIN THE ETHEREUM PLATFORM. WE HAVE NO CONTROL OVER AND MAKE NO GUARANTEES OR PROMISES WITH RESPECT TO SMART CONTRACTS.
                </p>
                <p>
                ...
                <p>
                  A. The prices of blockchain assets are extremely volatile. Fluctuations in the price of other digital assets could materially and adversely affect the value of your Piggy contributions, which may also be subject to significant price volatility. We cannot guarantee that any Piggy contributor will not lose money.
                </p>
                <p>
                  B. You are solely responsible for determining what, if any, taxes apply to your Piggy-related transactions. FidEver is not responsible for determining the taxes that apply to your transactions on the App, the Site, or the Smart Contracts.
                </p>
                <p>
                  C. The App does not store, send, or receive Piggy contributions. This is because Piggy contributions exist only by virtue of the ownership record maintained on the App’s supporting blockchain in the Ethereum network. Any Piggy contribution occurs within the supporting blockchain in the Ethereum network, and not on the App.
                </p>
                <p>
                  D. There are risks associated with using an Internet-based currency, including, but not limited to, the risk of hardware, software and Internet connections, the risk of malicious software introduction, and the risk that third parties may obtain unauthorized access to information stored within your wallet. You accept and acknowledge that FidEver will not be responsible for any communication failures, disruptions, errors, distortions or delays you may experience when using the Ethereum network, however caused.
                </p>
                <p>
                  E. A lack of use or public interest in the creation and development of distributed ecosystems could negatively impact the development of the Piggy Breaker ecosystem, and therefore the potential utility or value of Piggy contributions.
                </p>
                <p>
                  F. The regulatory regime governing blockchain technologies, cryptocurrencies, and tokens is uncertain, and new regulations or policies may materially adversely affect the development of the Piggy Breaker ecosystem, and therefore the potential utility or value of Piggy contributions.
                </p>
                <p>
                ...
                <p>
                  You agree to hold harmless and indemnify FidEver and its subsidiaries, affiliates, officers, agents, employees, advertisers, licensors, suppliers or partners from and against any claim, liability, loss, damage (actual and consequential) of any kind or nature, suit, judgment, litigation cost, and attorneys’ fees arising out of or in any way related to (i) your breach of these Terms, (ii) your misuse of the App, or (iii) your violation of applicable laws, rules or regulations in connection with your access to or use of the App.  You agree that FidEver will have control of the defense or settlement of any such claims.
                </p>
                ...
                <p>
                  Please read this Section 15 carefully. It requires you to arbitrate disputes with FidEver, and limits the manner in which you can seek relief from us.
                </p>
                <p>
                  All disputes arising out of or in connection with these Terms, including without limitation your access or use of the App, the Site, or the Smart Contracts, or to any products sold or distributed through the App, the Site, or the Smart Contracts, will be referred to and finally resolved by arbitration under the rules of the Tribunal de Commerce de Paris. The appointing authority will be the Tribunal de Commerce de Paris. The case will be adjudicated by a single arbitrator and will be administered by the Tribunal de Commerce de Paris in accordance with its applicable rules. Each party will cover its own fees and costs associated with the arbitration proceedings; however, if the arbitrator finds that you cannot afford to pay the fees and costs reasonably associated with the arbitration proceedings, FidEver will pay them for you. The place of arbitration will be Paris, France. You may choose to have the arbitration conducted by telephone, based on written submissions. The language of the arbitration will be French. The award of the arbitrator will be final and binding, and any judgment on the award rendered by the arbitrator may be entered in any court of competent jurisdiction. Notwithstanding the foregoing, FidEver may seek and obtain injunctive relief in any jurisdiction in any court of competent jurisdiction, and you agree that these Terms are specifically enforceable by FidEver through injunctive relief and other equitable remedies without proof of monetary damages.
                </p>
                <p>
