          ...
          <v-container grid-list-xl>
            <v-layout row wrap>
              ...
              <v-flex md10 offset-md1>
                ...
                <p>
                  B. Any contributor can decide to break the Piggy if the last contribution is older than five minutes. A winner is then chosen “randomly” e.g. the chances for a contributor to be declared winner are proportional to the amount contributed in the Piggy. For instance, a player who contributed 25 in a Piggy, which has a Piggy value of 100, has 25% chances to be chosen as winner. Once the Piggy is broken no one can contribute in it anymore and a new Piggy is instantly created with an initial Piggy value of zero. The players can now contribute in the new Piggy.
                </p>
                <p>
