          ...
          <v-container grid-list-xl>
            <v-layout row wrap>
              ...
              <v-flex md10 offset-md1>
                ...
                <p>
                  B. You are solely responsible for determining what, if any, taxes apply to your Piggy-related transactions. We are not responsible for determining the taxes that apply to your transactions on the App, the Site, or the Smart Contracts.
                </p>
                <p>
